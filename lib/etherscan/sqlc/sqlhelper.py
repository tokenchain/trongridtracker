...
class BlockChainCase(ManageDB):
    ...
    def has_the_address(self, table_name: str, hash: str) -> bool:
        cursor = self.conn.cursor()
    ...
    def update_data_hash(self, table_name: str, hash: str, params: dict) -> bool:
        ...
        if self.has_the_address("transaction_cache", hash) is False:
            return False
...
class LargeCacheTransferToDb(FolderBase):
    ...
    def find_in_cache(self, hash: str) -> bool:
        return self.sb.has_the_address("transaction_cache", hash)
    ...
    def process(self, hash: str, blob: str) -> bool:
        if self.sb.has_the_address("transaction_cache", hash) is True:
            return False
    ...
    def processUpdate(self, hash: str, blob: str) -> bool:
        if self.sb.has_the_address("transaction_cache", hash) is False:
            return False
